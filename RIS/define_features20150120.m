...
%preva = false(m0,n0);
%preve = false(m0,n0);
%prevr_last = false(m0,n0);
%preva_last = false(m0,n0);
%preve_last = false(m0,n0);
%pktype1 = uint8(zeros(m0,n0));   % 0(undefine), 1(valley), 2(peak)
pkval1p = single(ones(m0,n0));
pkval1v = single(zeros(m0,n0));
%pktype2 = uint8(zeros(m0,n0));   % 0(undefine), 1(valley), 2(peak)
pkval2p = single(ones(m0,n0));
pkval2v = single(zeros(m0,n0));
for p = (hsz+ceil(hsz/2)):(p0-hsz-floor(hsz/2))
    tmp0 = cube(:,:,(p-1):(p+1));
    tmp = der1(:,:,(p-1):(p+1));
    tmp1 = der2(:,:,(p-1):(p+1));
    pkdelta_thresh1 = 0.01;
    ...
    for i = 1:L
        %if (pktype2(r(i),c(i)) ~= 2)
            pkdelta = abs(pkval2v(r(i),c(i)) - tmp(r(i),c(i),2));
            if (pkdelta >= pkdelta_thresh2)
                % if the peak is greater than 0
                %if ((tmp(r(i),c(i),2) > 0) && (mu_cube(r(i),c(i)) > dark_thresh) && (tmp(r(i),c(i),2) > tmp(r(i),c(i),1)) && (tmp(r(i),c(i),2) > tmp(r(i),c(i),3)))
                if ((tmp(r(i),c(i),2) > 0) && (mu_cube(r(i),c(i)) > dark_thresh))
                    %if (preve(r(i),c(i)) == 0)
                        edge_list(ptote,:) = [r(i) c(i) lambda(p) p];
                        %pktype2(r(i),c(i)) = 2;
                        %pkval2p(r(i),c(i)) = tmp(r(i),c(i),2);
                        %preve(r(i),c(i)) = 1;
                        ptote = ptote + 1;
                    %else
                    %    preve(r(i),c(i)) = 0;
            ...
            elseif (pkdelta >= (pkdelta_thresh2/2))
                %if ((tmp(r(i),c(i),2) <= 0) && (mu_cube(r(i),c(i)) > dark_thresh) && (tmp(r(i),c(i),2) > tmp(r(i),c(i),1)) && (tmp(r(i),c(i),2) > tmp(r(i),c(i),3)))
                if ((tmp(r(i),c(i),2) <= 0) && (mu_cube(r(i),c(i)) > dark_thresh))
                    %if (preva(r(i),c(i)) == 0)
                        apeak_list(ptota,:) = [r(i) c(i) lambda(p) p];
                        %pktype1(r(i),c(i)) = 2;
                        %pkval1(r(i),c(i)) = cube(r(i),c(i),2);
                        %pktype2(r(i),c(i)) = 2;
                        %pkval2p(r(i),c(i)) = tmp(r(i),c(i),2);
                        %preva(r(i),c(i)) = 1;
                        ptota = ptota + 1;
    ...
    for i = 1:L
        %if (pktype2(r(i),c(i)) ~= 1)
            pkdelta = abs(pkval2p(r(i),c(i)) - tmp(r(i),c(i),2));
    ...
    for i = 1:L
        %if (pktype1(r(i),c(i)) ~= 2)
            pkdelta = abs(pkval1v(r(i),c(i)) - tmp0(r(i),c(i),2));
            if (pkdelta >= pkdelta_thresh1)
                %if ((mu_cube(r(i),c(i)) > dark_thresh) && (tmp0(r(i),c(i),2) > tmp0(r(i),c(i),1)) && (tmp0(r(i),c(i),2) > tmp0(r(i),c(i),3)))
                if ((mu_cube(r(i),c(i)) > dark_thresh))
                    %if (prevr(r(i),c(i)) == 0)
                        rpeak_list(ptotr,:) = [r(i) c(i) lambda(p) p];
                        %pktype1(r(i),c(i)) = 2;
                        %pkval1p(r(i),c(i)) = tmp0(r(i),c(i),2);
                        %prevr(r(i),c(i)) = 1;
                        ptotr = ptotr + 1;
                    %else
                    %    prevr(r(i),c(i)) = 0;
    ...
    for i = 1:L
        %if (pktype1(r(i),c(i)) ~= 1)
            pkdelta = abs(pkval1p(r(i),c(i)) - tmp0(r(i),c(i),2));
            if (pkdelta >= pkdelta_thresh1)
                %if ((mu_cube(r(i),c(i)) > dark_thresh) && (tmp0(r(i),c(i),2) < tmp0(r(i),c(i),1)) && (tmp0(r(i),c(i),2) < tmp0(r(i),c(i),3)))
                if ((mu_cube(r(i),c(i)) > dark_thresh))
                    %if (preva(r(i),c(i)) == 0)
                        apeak_list(ptota,:) = [r(i) c(i) lambda(p) p];
                        %pktype1(r(i),c(i)) = 1;
                        %pkval1v(r(i),c(i)) = tmp0(r(i),c(i),2);
                        %preva(r(i),c(i)) = 1;
                        ptota = ptota + 1;
                    %else
                    %    preva(r(i),c(i)) = 0;
    ...
    %preva(and(preva,preva_last)) = 0;
    %prevr(and(prevr,prevr_last)) = 0;
    %preve(and(preve,preve_last)) = 0;
    %preva_last = preva;
    %prevr_last = prevr;
    %preve_last = preve;
end
