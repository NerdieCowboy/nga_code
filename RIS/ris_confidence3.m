...
for m = 1:blksz:m0
    ...
    for n = 1:blksz:n0
        ...
        [features0,tot_ris_table,Lp,Lf] = match_features(cube(m:mend,n:nend,:),der1(m:mend,n:nend,:),der2(m:mend,n:nend,:),der3(m:mend,n:nend,:),fn_path,features_table_fn,spectra_lib,spectra_names,pk_dist_range,bw_dist_range,pkdelta_thresh1,pkdelta_thresh2);
...
[featuresL,tot_ris_tableL,LpL,LfL] = match_features(cube,der1,der2,der3,fn_path,features_table_fn,spectra_lib,spectra_names,pk_dist_range,bw_dist_range,pkdelta_thresh1,pkdelta_thresh2);
