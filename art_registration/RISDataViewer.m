function varargout = RISDataViewer(varargin)
% RISDATAVIEWER MATLAB code for RISDataViewer.fig
%      RISDATAVIEWER, by itself, creates a new RISDATAVIEWER or raises the existing
%      singleton*.
%
%      H = RISDATAVIEWER returns the handle to a new RISDATAVIEWER or the handle to
%      the existing singleton*.
%
%      RISDATAVIEWER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RISDATAVIEWER.M with the given input arguments.
%
%      RISDATAVIEWER('Property','Value',...) creates a new RISDATAVIEWER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before RISDataViewer_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to RISDataViewer_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help RISDataViewer

% Last Modified by GUIDE v2.5 15-Jul-2015 11:54:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @RISDataViewer_OpeningFcn, ...
                   'gui_OutputFcn',  @RISDataViewer_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before RISDataViewer is made visible.
function RISDataViewer_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to RISDataViewer (see VARARGIN)

% Choose default command line output for RISDataViewer
...
% UIWAIT makes RISDataViewer wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = RISDataViewer_OutputFcn(hObject, eventdata, handles) 
