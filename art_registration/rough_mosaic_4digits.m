...
while (inc < p2)
    p0 = p0 + 1;
    if (pc == 1)
        fn_full2 = [fn_path2 trial num2str(sprintf('%04.0f',p0)) '.tif'];
    elseif (pc == 0)
        fn_full2 = [fn_path2 trial num2str(sprintf('%04d',p0)) '.tif'];
    end
...
for inc = 1:p0
    if (pc == 1)
        fn_full2 = [fn_path2 trial num2str(sprintf('%04.0f',inc)) '.tif'];
    elseif (pc == 0)
        fn_full2 = [fn_path2 trial num2str(sprintf('%04d',inc)) '.tif'];
    end
